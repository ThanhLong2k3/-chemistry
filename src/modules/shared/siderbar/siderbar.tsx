...
import { ADMIN_MANAGE_ACCOUNT_PATH, ADMIN_MANAGE_ADVISORY_MEMBER_PATH, ADMIN_MANAGE_BLOG_PATH, ADMIN_MANAGE_CHAPTER_PATH, ADMIN_MANAGE_EXAM_PATH, ADMIN_MANAGE_LESSON_PATH, ADMIN_MANAGE_PROFILE_PATH, ADMIN_MANAGE_ROLE_PATH, ADMIN_MANAGE_SUBJECT_PATH, ADMIN_DASHBOARD_PATH } from '@/path';
