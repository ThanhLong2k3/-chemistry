...
import { UserOutlined, BookOutlined, TeamOutlined, BankOutlined, ClockCircleOutlined } from '@ant-design/icons';
    ...
    <div className={styles.container}>
      <div className={styles.header}>
        ...
        <Text className={styles.subtitle}>
          Danh sách các thành viên ban tư vấn với kinh nghiệm và chuyên môn cao
        </Text>
      </div>
            ...
            <Card className={styles.memberCard}>
              ...
              <div className={styles.infoSection}>
                <div className={styles.infoRow}>
                  ...
                  <Tag color={getDegreeColor(member.degree)} className={styles.degreeTag}>
                    {member.degree}
                  </Tag>
                </div>
                ...
                <div className={styles.classesSection}>
                  <Text strong className={styles.classesTitle}>Lớp phụ trách:</Text>
                  <div className={styles.classesContainer}>
                    {member.classesInCharge.map((className, index) => (
                      <Tag key={index} color="#f0f0f0" className={styles.classTag}>
                        {className}
                      </Tag>
                    ))}
                  </div>
