...
import { ADMIN_USER_PATH, ADVISORY_BOARD_PATH, BASE_PATH, HOME_PATH, LESSON_DETAIL_PATH, LESSON_LIST_PATH, LOGIN_PATH, PERIODIC_TABLE_PATH, REGISTER_PATH, REVIEW_FILE_PDF_PATH, FOGOTPASS_PATH, BLOG_LIST_PATH, BLOG_DETAIL_PATH } from "@/path"
...
export default function RootLayout({ children }: RootLayoutProps) {
  ...
  const isAuthPage = pathname === BASE_PATH || pathname === REGISTER_PATH || pathname === HOME_PATH || pathname === LOGIN_PATH || pathname === ADMIN_USER_PATH ||
    pathname === ADVISORY_BOARD_PATH || pathname === PERIODIC_TABLE_PATH || isLessonListPage || isLessonDetailPage || isOpenPDFPage || pathname === FOGOTPASS_PATH || pathname === "/" || pathname === BLOG_LIST_PATH ||  pathname === BLOG_DETAIL_PATH ;
